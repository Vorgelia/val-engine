...
public:
	std::shared_ptr<BaseScriptVariable> AddMember(std::string name, std::shared_ptr<BaseScriptVariable> var);
	std::shared_ptr<BaseScriptVariable> GetMember(std::string name);
